...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  for (const section of sections) classes.set(section.class.id, { id: section.id, label: formatClassLabel(section.class.department.name, section.class.semester, section.name) });
