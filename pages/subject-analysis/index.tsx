    ...
    <div className="min-h-screen max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="mt-8 mb-6">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Select a class you are assigned to, then choose one of your assigned subjects.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <select
          ...
          className="w-full rounded-lg border border-gray-200 px-3 py-3 text-sm text-gray-900"
        >
        ...
        <div className="mt-6">
          ...
          <div className="space-y-2">
            ...
            {!selectedSubjects.length && (
              <p className="text-sm text-gray-400 py-2">No assigned subjects for this class.</p>
            )}
          </div>
        </div>
      </div>
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const sections = await prisma.section.findMany({
    ...
    include: {
      ...
      subjects: {
        where: role === "ADMIN" ? undefined : { assignments: { some: { teacherId: userId } } },
      },
    },
  });
  ...
  const subjects = sections.flatMap((section) =>
