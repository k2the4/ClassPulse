...
export default function SubjectOverallPage() {
  ...
  function applyRiskFilters() {
    ...
    setRiskColumn(draftRiskColumn); setRiskLower(lo); setRiskUpper(hi); setSortDirection(draftSortDirection);
  }
