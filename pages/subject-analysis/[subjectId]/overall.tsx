...
function riskScoreClass(value: number) {
  if (value > 32) return "text-blue-600 font-semibold";
...
function riskStatus(value: number) {
  if (value > 32) return { label: "Excellent", className: "bg-blue-50 text-blue-700" };
